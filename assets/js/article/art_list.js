$(function() {
    ...
    // 定义美化时间的过滤器
    template.defaults.imports.dataTime = function(date) {
        ...
        var minutes = padZero(dt.getMinutes());
    ...
    function initCata() {
        $.ajax({
            ...
            success: function(res) {
                ...
                // 通知 layui 重新渲染 ui 结构对象
                form.render();
            }
        })
    }

    // 为筛选表单绑定submit事件 (实现筛选功能)
    ...
    function renderPage(total) {
        ...
        laypage.render({
            ...
            jump: function(obj, first) {
                ...
                q.pagesize = obj.limit; // 可以实现每页显示多少条
